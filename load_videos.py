...
# Delete multiprocessing part cause it occurs unexpected error
...
def download(video_id, args):
    ...
    print("args", args.youtube)
    print("vid path", video_path)

    vid_url = "https://www.youtube.com/watch?v=" + video_id


    cmd = 'youtube-dl -f best/mp4 --write-auto-sub --write-sub --sub-lang en --skip-unavailable-fragments ' + vid_url + " --output " +  video_path
    print(cmd)
    os.system(cmd)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_folder", default='youtube-dl', help='Path to youtube videos')
    parser.add_argument("--metadata", default='taichi-metadata-new.csv', help='Path to metadata')
    parser.add_argument("--out_folder", default='ted-png', help='Path to output')
    ...
    for a, b in zip(video_ids, args_list):
        # print(a, b)
        run((a, b))
